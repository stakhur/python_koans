...
class Proxy:
    ...
    # WRITE CODE HERE
    def number_of_times_called(self, property):
        called = 0
        if property in self._number_of_times_called:
            called = self._number_of_times_called[property]
        
        return called
    

    def was_called(self, property):
